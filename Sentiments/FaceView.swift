...
class FaceView: UIView {
    ...
    @IBInspectable var isVisible: Bool = true { didSet { setNeedsDisplay() } }
    
    @IBInspectable var smiliness: Double = 0.0 { didSet { setNeedsDisplay() } }
    ...
    override func draw(_ rect: CGRect) {
        ...
        let smiliness = dataSource?.smilinessForFaceView(self) ?? self.smiliness
